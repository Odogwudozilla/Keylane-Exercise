...
class TriangleTypes
  ...
  #prompts the user for the right input.
  def prompts
  ...
  #Method checks for the validity of the triangle and then sorts the array
  def methodlogic
  ...
  #Method runs instances of other methods and does the final logic
  def checkvalue
    prompts
    userinput
    methodlogic
